...
const char descriptor_table_protodef_status_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "eapis/rpc/status;status\370\001\001\242\002\003RPCb\006proto3"
};
...
::uint8_t* Status::_InternalSerialize(
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "google.rpc.Status.message");
